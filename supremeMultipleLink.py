...
atcembed.add_embed_field(name='Product Link', value='(keys["productlink])')
atcembed.add_embed_field(name='Mode', value='Browser')
atcembed.add_embed_field(name='Notes', value='What It Do Bruh')
atcembed.add_embed_field(name='Motivation', value='You Got It Big Man')
...
captchaembed.add_embed_field(name='Product Link', value='(keys["productlink])')
captchaembed.add_embed_field(name='Mode', value='Browser')
captchaembed.add_embed_field(name='Notes', value='Go Cook Yea')
captchaembed.add_embed_field(name='Motivation', value='Massive W Incoming')
...
paymentembed.add_embed_field(name='Product Link', value='(keys["productlink])')
paymentembed.add_embed_field(name='Mode', value='Browser')
paymentwebhook.add_embed(paymentembed)

keys = {
    "productlink": "https://www.supremenewyork.com/shop/bags/htfkchp9e/t8qwi0tv5",
    "productlink2": "https://www.supremenewyork.com/shop/bags/htfkchp9e/t8qwi0tv5",
    "name": "John Doe",
